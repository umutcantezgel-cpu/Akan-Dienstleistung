...
const getSnapshotMobile = () => window.innerWidth < 1024;
const getServerSnapshotMobile = () => false;
...
export default function ReadMoreExpander({
    ...
    const isMobile = useSyncExternalStore(subscribeResize, getSnapshotMobile, getServerSnapshotMobile);
