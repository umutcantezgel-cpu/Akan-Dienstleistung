...
import { ArrowLeft, CheckCircle2, ArrowRight, Building2, Sparkles, AlertTriangle, Factory } from 'lucide-react';
...
export default function ServiceDetailBlueprint({ service }: ServiceDetailBlueprintProps) {
            ...
            <header className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-surface">
                <div className="container-fluid relative z-10">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-primary/10 text-primary mb-8 shadow-inner-glow group">
                            <Icon className="w-10 h-10 svg-draw-effect" />
                        </motion.div>
                        <motion.h1 variants={fadeInUp} className="text-4xl lg:text-6xl font-black text-text-primary uppercase tracking-tighter mb-6">
                            {service.title}
                        </motion.h1>
                        <motion.p variants={fadeInUp} className="text-xl lg:text-2xl text-text-secondary font-medium tracking-wide mb-10 text-measure mx-auto">
                            {service.subtitle}
                        </motion.p>
                        <motion.div variants={fadeInUp}>
                            <Button href="/contact" size="lg" className="shadow-lg shadow-primary/25 animate-pulse-glow">
                        ...
                        >
                            ...
                            <ul className="space-y-4">
                                {service.painPoints.map((pain, idx) => (
                                    <li key={idx} className="flex items-start gap-4 p-4 rounded-xl bg-surface border border-border/40">
            ...
            <section className="py-section bg-surface">
                <div className="container-fluid">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-text-primary font-display mb-4">Ihre Vorteile mit AKAN</h2>
                        <p className="text-text-secondary max-w-2xl mx-auto">Wir lösen Probleme nicht nur, wir beseitigen ihre Ursachen.</p>
                    </div>
                ...
                <div className="container-fluid max-w-5xl mx-auto">
                    <div className="bg-primary text-white rounded-[2.5rem] p-10 lg:p-16 relative overflow-hidden shadow-card text-center">
                        <div className="relative z-10">
                            <h2 className="text-3xl lg:text-4xl font-black uppercase tracking-tight mb-8">Was gehört dazu?</h2>
                            ...
                            <Button href="/contact" variant="secondary" size="lg" className="!bg-transparent !border-2 !border-white !text-white hover:!bg-white hover:!text-primary shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                ...
                <section className="py-section-lg bg-surface border-t border-border/60">
                    <div className="container-fluid">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-text-primary mb-4 font-display">Das könnte Sie auch interessieren</h2>
                            <p className="text-text-secondary">Entdecken Sie unsere weiteren Reinigungsdienstleistungen.</p>
                        </div>
                        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            {relatedServices.map((relatedService, idx) => {
                                const RelatedIcon = iconMap[relatedService.iconName] || Building2;
                                return (
                                    <motion.div
