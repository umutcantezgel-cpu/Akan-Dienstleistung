...
function ClearHero({ service }: Props) {
    return (
        <section
            className="relative pt-40 pb-32 lg:pt-48 lg:pb-40 overflow-hidden bg-blue-50/50 isolation-isolate min-h-[80vh] flex items-center"
        >
            {/* Background Image */}
            <div className="absolute inset-0 z-0">
                <ImagePlaceholder alt={service.imagePlaceholderAlt} fill className="object-cover" />
            </div>
            ...
            <div className="container-fluid relative z-30">
                <motion.div variants={staggerContainer} initial="initial" animate="animate" className="max-w-3xl">
                    <motion.div variants={fadeInUp} className="mb-8">
                        <Link href="/leistungen" className="inline-flex items-center gap-2 text-sm font-bold text-blue-900 hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 rounded-sm bg-white px-4 py-2 rounded-full shadow-sm">
                            <ArrowLeft className="w-4 h-4" />
                            Zurück zu Services
                        </Link>
                    </motion.div>

                    <motion.div variants={fadeInUp} className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white text-blue-600 mb-8 shadow-lg border border-white">
                    ...
                    <motion.p variants={fadeInUp} className="text-xl lg:text-2xl text-blue-900 font-medium tracking-wide mb-10 text-measure bg-white p-6 rounded-3xl shadow-lg border border-blue-50">
                        {service.subtitle}
                    </motion.p>

                    <motion.div variants={fadeInUp}>
                        <Button href="/contact" size="lg" className="shadow-[0_10px_40px_rgba(37,99,235,0.3)] bg-blue-600 hover:bg-blue-700 text-white border-none">
                ...
                <div className="container-fluid max-w-6xl mx-auto relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            {service.description} Repräsentative Fensterfronten für Ihr Unternehmen.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { icon: Eye, title: "Streifenfreie Sicht", desc: "Spezial-Osmoseverfahren für rückstandslose Trocknung auch bei starker Sonneneinstrahlung." },
                            { icon: Sun, title: "Rahmenschonend", desc: "Intensive Pflege von Eloxal-, Kunststoff- und Holzrahmen für langfristigen Werterhalt." },
                            { icon: Shield, title: "Sichere Höhenzugänge", desc: "Hubsteiger- und Seilzugangstechnik für schwer erreichbare Glasfassaden & Wintergärten." }
                        ].map((feature, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-32 bg-slate-900 text-white relative">
                <div className="container-fluid max-w-5xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-4xl font-bold mb-8">Was gehört zur professionellen Glasreinigung?</h2>
                            ...
                            <div className="mt-12">
                                <Button href="/contact" variant="primary" size="lg" className="bg-white text-slate-900 hover:bg-blue-50">
                        ...
                        <div className="relative aspect-square rounded-[3rem] overflow-hidden">
                            ...
                            <div className="absolute inset-4 z-10 rounded-[2rem] border border-white/20 bg-white/10 backdrop-blur-sm shadow-2xl flex items-end p-8">
                                <div className="bg-black/40 backdrop-blur-md text-white p-6 rounded-2xl border border-white/10">
                                    ...
                                    <p className="text-sm text-slate-300 opacity-90">Wir reinigen mit System und garantieren Ergebnisse ohne Kompromisse.</p>
                                </div>
                            </div>
                            <ImagePlaceholder alt="Perfekte Glasfassade" fill className="object-cover" />
                        </div>
                    </div>
                </div>
            </section>
