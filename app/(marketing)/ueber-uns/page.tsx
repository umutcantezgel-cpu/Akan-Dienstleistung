...
export const metadata = {
  ...
  description: 'Lernen Sie das Team hinter AKAN Dienstleistung kennen. 10 Jahre Erfahrung, Familienbetrieb, Meisterqualität in Unterhalts- und Gebäudereinigung.',
  keywords: ['Reinigungsfirma Gudensberg', 'AKAN Dienstleistung Team', 'Gebäudereinigung Erfahrung', 'Familienunternehmen Kassel'],
};
...
export default function About() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <a href="#values" className="inline-flex justify-center items-center px-8 py-4 border border-border text-base font-bold tracking-wide rounded-xl text-text-primary bg-white hover:border-primary/50 hover:bg-surface transition-all font-display shadow-soft">
                  Unsere Werte
                </a>
              </div>
            </div>
            <div className="order-1 lg:order-2 relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white/95 backdrop-blur-md p-8 rounded-3xl shadow-card border border-border max-w-xs animate-bounce" style={{ animationDuration: '4s' }}>
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <p className="text-tiny uppercase tracking-wider font-semibold text-text-secondary mb-1">Erfahrung</p>
                    <p className="text-2xl font-bold text-text-primary font-display tracking-tight">Über 10 Jahre</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="team" className="py-section-lg bg-surface border-y border-border relative">
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14">
            <div className="group relative bg-white rounded-[2rem] overflow-hidden border border-border hover:border-primary/30 transition-all duration-500 shadow-soft hover:shadow-card">
              ...
              <div className="p-8 lg:p-12">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-3xl font-bold text-text-primary font-display mb-2 drop-shadow-sm">Cemal Hilaloglu</h3>
                    <p className="text-primary font-bold text-tiny uppercase tracking-widest">Inhaber & Gründer</p>
                  </div>
                ...
                <p className="text-medium font-light text-text-secondary mb-10 italic leading-[1.8]">
                  &quot;Mein Ziel war es, eine Struktur zu schaffen, in der Vertrauen kein leeres Wort ist, sondern das Ergebnis täglicher, harter Arbeit und kompromissloser Qualität.&quot;
                </p>
                <div className="border-t border-border pt-8">
                  <span className="text-mini font-bold text-text-secondary uppercase tracking-[0.2em] block mb-4">Fokus</span>
                  <div className="flex flex-wrap gap-3">
                    <span className="px-4 py-2 bg-surface rounded-xl border border-border text-tiny font-bold text-text-primary shadow-sm hover:shadow-md transition-shadow">Strategie</span>
                    <span className="px-4 py-2 bg-surface rounded-xl border border-border text-tiny font-bold text-text-primary shadow-sm hover:shadow-md transition-shadow">Kundenbeziehungen</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="group relative bg-white rounded-[2rem] overflow-hidden border border-border hover:border-primary/30 transition-all duration-500 shadow-soft hover:shadow-card">
              ...
              <div className="p-8 lg:p-12">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h3 className="text-3xl font-bold text-text-primary font-display mb-2 drop-shadow-sm">Zeynep Hilaloglu</h3>
                    <p className="text-primary font-bold text-tiny uppercase tracking-widest">Objektleiterin</p>
                  </div>
                  <div className="bg-surface p-4 rounded-2xl text-primary shadow-inner-glow border border-border">
                ...
                <p className="text-medium font-light text-text-secondary mb-10 italic leading-[1.8]">
                  &quot;Nach 10 Jahren in der Branche weiß ich: Exzellenz steckt im Detail. Wir sorgen dafür, dass jeder Handgriff sitzt und unsere hohen Standards immer erfüllt werden.&quot;
                </p>
                <div className="border-t border-border pt-8">
                  <span className="text-mini font-bold text-text-secondary uppercase tracking-[0.2em] block mb-4">Fokus</span>
                  <div className="flex flex-wrap gap-3">
                    <span className="px-4 py-2 bg-surface rounded-xl border border-border text-tiny font-bold text-text-primary shadow-sm hover:shadow-md transition-shadow">Qualitätsmanagement</span>
                    <span className="px-4 py-2 bg-surface rounded-xl border border-border text-tiny font-bold text-text-primary shadow-sm hover:shadow-md transition-shadow">Teamführung</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-fluid">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-surface p-10 lg:p-12 rounded-[2rem] shadow-soft border border-border hover:shadow-card hover:-translate-y-2 transition-all duration-500 group">
              ...
              <h3 className="text-2xl font-bold text-text-primary mb-5 font-display tracking-tight">Höchste Standards</h3>
              <p className="text-medium font-light text-text-secondary leading-[1.8]">
                Wir geben uns nicht mit dem Durchschnitt zufrieden. Unsere Prozesse und Qualitätskontrollen sichern ein makelloses Ergebnis für jeden Auftrag.
              </p>
            </div>
            <div className="bg-surface p-10 lg:p-12 rounded-[2rem] shadow-soft border border-border hover:shadow-card hover:-translate-y-2 transition-all duration-500 group">
              ...
              <h3 className="text-2xl font-bold text-text-primary mb-5 font-display tracking-tight">Persönlicher Service</h3>
              <p className="text-medium font-light text-text-secondary leading-[1.8]">
                Trotz Digitalisierung steht der Mensch im Mittelpunkt. Wir sind greifbar, hören zu und finden individuelle Lösungen für Ihre Anforderungen.
              </p>
            </div>
            <div className="bg-surface p-10 lg:p-12 rounded-[2rem] shadow-soft border border-border hover:shadow-card hover:-translate-y-2 transition-all duration-500 group">
              ...
              <h3 className="text-2xl font-bold text-text-primary mb-5 font-display tracking-tight">Zuverlässigkeit</h3>
              <p className="text-medium font-light text-text-secondary leading-[1.8]">
                Ein Wort ist ein Wort. Unsere Kunden in Nordhessen schätzen unsere absolute Termintreue, Diskretion und transparente Kommunikation.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-6 p-6 bg-white rounded-2xl border border-border shadow-soft group hover:shadow-card transition-shadow">
                  <div className="w-16 h-16 rounded-xl bg-surface shadow-inner-glow flex items-center justify-center text-trust-gold font-bold font-display text-2xl group-hover:scale-110 transition-transform">10</div>
                  <div>
                    <span className="block text-text-primary font-bold tracking-tight text-lg mb-1">Motivierte Mitarbeiter</span>
                    <span className="text-base font-light text-text-secondary">Ihr festes Reinigungsteam</span>
                  </div>
                </div>
                <div className="flex items-center gap-6 p-6 bg-white rounded-2xl border border-border shadow-soft group hover:shadow-card transition-shadow">
                  <div className="w-16 h-16 rounded-xl bg-surface shadow-inner-glow flex items-center justify-center text-accent font-bold font-display text-2xl group-hover:scale-110 transition-transform">100%</div>
                  <div>
                    <span className="block text-text-primary font-bold tracking-tight text-lg mb-1">Einsatzbereitschaft</span>
                    <span className="text-base font-light text-text-secondary">Für makellose Ergebnisse</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-5 mb-14">
                <li className="flex items-center gap-5 p-5 bg-surface rounded-2xl border border-border shadow-soft">
                  ...
                  <span className="font-bold text-text-primary tracking-wide">Gudensberg (Hauptsitz)</span>
                </li>
                <li className="flex items-center gap-5 p-5 bg-surface rounded-2xl border border-border shadow-soft">
                  <MapPin className="text-trust-gold w-6 h-6 shrink-0" />
                  <span className="font-bold text-text-primary tracking-wide">Kassel & Umgebung</span>
                </li>
                <li className="flex items-center gap-5 p-5 bg-surface rounded-2xl border border-border shadow-soft">
                  <MapPin className="text-accent w-6 h-6 shrink-0" />
                  <span className="font-bold text-text-primary tracking-wide">Fritzlar & Melsungen</span>
                </li>
              </ul>
              <Link href="/contact" className="inline-flex items-center gap-3 bg-primary hover:bg-primary-hover text-white px-10 py-4 rounded-xl font-bold transition-all shadow-elevated tracking-wide text-base">
      ...
      <section className="py-20 bg-background border-t border-border">
        <div className="container-fluid text-center">
          <p className="text-text-secondary font-bold mb-10 uppercase tracking-[0.25em] text-mini">Unsere Partner & Zertifizierungen</p>
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all duration-700">
            <div className="flex items-center gap-3 text-text-secondary hover:text-text-primary transition-colors">
              ...
              <span className="font-bold text-2xl font-display tracking-tight">TÜV Nord</span>
            </div>
            <div className="flex items-center gap-3 text-text-secondary hover:text-text-primary transition-colors">
              <Building2 className="w-10 h-10" />
              <span className="font-bold text-2xl font-display tracking-tight">IHK Hessen</span>
            </div>
            <div className="flex items-center gap-3 text-text-secondary hover:text-text-primary transition-colors">
              <Leaf className="w-10 h-10" />
              <span className="font-bold text-2xl font-display tracking-tight">EcoClean</span>
            </div>
            <div className="flex items-center gap-3 text-text-secondary hover:text-text-primary transition-colors">
              <BadgeCheck className="w-10 h-10" />
              <span className="font-bold text-2xl font-display tracking-tight">ISO 9001</span>
            </div>
          </div>
        </div>
      </section>
