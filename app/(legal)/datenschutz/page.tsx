...
import { Info, Server, Scale, Cookie, Mail, Share2, Users } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <p>
          ...
          Kontaktformular eingeben oder uns per E-Mail übersenden.
        </p>
        <p>
        ...
        <p>
          ...
          Nutzerverhaltens verwendet werden oder um Ihre geschäftlichen Anfragen
          (Auftragsabwicklung im B2B/B2C-Bereich) zügig zu bearbeiten.
        </p>
      ...
      <LegalAccordion title="Server & Infrastruktur" icon={<Server />}>
        <p>
          Wir hosten die Website bei einem externen Dienstleister (Hoster). Die
      ...
      <h2 id="allgemeine-hinweise-pflichtinformationen">
        3. Allgemeine Hinweise und Pflichtinformationen
      </h2>

      <LegalAccordion title="Datenschutz & Rechte" icon={<Scale />}>
        <p>
          Als Gebäudereinigungs- und Facility-Management-Unternehmen gehen wir
          täglich mit sensiblen Kundenbereichen um. Diese Diskretion spiegelt
          sich auch in unserem digitalen Auftritt wider. Die Betreiber dieser
        ...
        <h4 className="font-bold text-text-primary mt-8 mb-2">
        ...
        <h4 className="font-bold text-text-primary mt-8 mb-2">Speicherdauer</h4>
        <p>
        ...
        <p>
          Da wir als Unternehmen die gesetzlich vorgeschriebene Schwellengrenze
          in der Regel nicht überschreiten, haben wir keinen gesonderten
          Datenschutzbeauftragten bestellt. Alle datenschutzrelevanten Anfragen
          richten Sie bitte direkt an die Inhaberschaft (siehe „Verantwortliche
          Stelle“).
        </p>
      ...
      <LegalAccordion title="Cookies & Externe Medien" icon={<Cookie />}>
        <p>
          Unsere Internetseiten verwenden so genannte „Cookies“ und ähnliche
          Technologien (wie z.B. HTML5 Local Storage). Diese richten auf Ihrem
          Endgerät keinen Schaden an und enthalten keine Viren. Sie dienen dazu,
          unser Angebot nutzerfreundlicher, effektiver und sicherer zu machen.
        </p>
        <p>
          Wir nutzen auf dieser Website ein striktes, lokales
          Consent-Management-System (&quot;Zero-Tolerance Privacy&quot;). Es
          werden standardmäßig <strong>keine</strong> technisch nicht
          notwendigen Cookies gesetzt und <strong>keine</strong> Daten an
          Drittanbieter (wie Google) übertragen, bevor Sie nicht explizit
          eingewilligt haben.
        </p>
        ...
        <div className="my-8">
          ...
          <p className="text-sm text-text-secondary mb-4">
            Die folgende Tabelle zeigt in Echtzeit, welche Dienste aktuell auf
            Basis Ihrer persönlichen Datenschutzeinstellungen (Zustimmung oder
            Ablehnung) aktiv sind.
          </p>
          <CookieDeclarationClient />
          <p className="text-sm mt-4 italic text-text-secondary">
            Sie können Ihre getroffene Auswahl jederzeit über das
            Fingerabdruck-Symbol am unteren linken Bildschirmrand widerrufen
            oder anpassen. Bei einem Widerruf werden die entsprechenden Cookies
            in Ihrem Browser umgehend gelöscht.
          </p>
        </div>
      </LegalAccordion>

      <LegalAccordion title="Server-Log-Dateien" icon={<Server />}>
        <p>
      ...
      <LegalAccordion title="Kontaktformular & E-Mail Anfragen" icon={<Mail />}>
        <p>
      ...
      <LegalAccordion
        title="Verzicht auf aktive Social-Plugins"
        icon={<Share2 />}
      >
        <p>
          Im Bereich der B2B Dienstleistung greifen wir primär auf direkte
          Kommunikation zurück. Sollten auf unserer Website zukünftig Plugins
          von Plattformen wie LinkedIn oder Facebook integriert werden, so
          erfolgt dies nach der bewährten Shariff-Methode oder über einen
          2-Klick-Mechanismus, welcher sicherstellt, dass ohne Ihre explizite
          Handlung keine Daten an diese Netzwerke fließen.
        </p>
      </LegalAccordion>

      <h2 id="bewerbungen">6. Umgang mit Bewerberdaten</h2>
      <LegalAccordion title="Datenschutz im Bewerbungsprozess" icon={<Users />}>
        <p>
          Wir bieten Ihnen die Möglichkeit, sich bei uns zu bewerben (z. B. per
          E-Mail oder postalisch). Im Folgenden informieren wir Sie über Umfang,
          Zweck und Verwendung Ihrer im Rahmen des Bewerbungsprozesses erhobenen
        ...
        <p>
          ...
          Vorstellungsgesprächen etc.), soweit dies zur Entscheidung über die
          Begründung eines Beschäftigungsverhältnisses erforderlich ist.
          Rechtsgrundlage hierfür ist § 26 BDSG nach deutschem Recht sowie Art.
          6 Abs. 1 lit. b DSGVO.
        </p>
        ...
        <p>
          ...
          unserer berechtigten Interessen (Art. 6 Abs. 1 lit. f DSGVO) für bis
          zu 6 Monate aufzubewahren. Anschließend werden die Daten gelöscht und
          Unterlagen vernichtet, es sei denn es besteht eine gesetzliche
